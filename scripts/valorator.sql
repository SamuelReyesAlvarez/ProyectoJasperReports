...
INSERT INTO juego(nombre, estilo, publicacion, descripcion, precio) VALUES('Portal', 'sin_definir', '2007/10/09', 'Portal es un videojuego de lógica en primera persona para un solo jugador desarrollado por Valve Corporation. El juego se publicó en un paquete llamado The Orange Box', 12.95);
...
INSERT INTO juego(nombre, estilo, publicacion, descripcion, precio) VALUES('The Crew', 'sin_definir', '2014/12/02', 'The Crew es un videojuego de conducción multijugador situado en un entorno de mundo abierto basado en los Estados Unidos, desarrollado por Ivory Tower y distribuido por Ubisoft.', 24.95);
